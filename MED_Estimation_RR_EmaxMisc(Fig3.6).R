...
model_orig="sigEmax"
model_fit1="emax"
#Replace by "weights4" and "weights6" to generate the MED with the corresponding weights (Fig A.3 and A.4)
...
for(s in 1:2)
{
  ...
  r1<-ggpar(p10,orientation="horizontal", main = "Simulated From: sigEmax, Fitted on: sigEmax(ft,wt), emax(ft,wt)",font.main = c(10,"bold.italic", "red"),font.x = c(8, "bold", "#2E9FDF"),font.y = c(8, "bold", "#E7B800"),font.xtickslab = 8,font.ytickslab=8)
